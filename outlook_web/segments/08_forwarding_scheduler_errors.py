...
def process_forwarding_account(account_row: Dict[str, Any], job_config: Dict[str, Any]) -> Dict[str, Any]:
    with app.app_context():
        ...
        try:
            ...
            forward_match_rules = job_config.get('forward_match_rules') or []
            ...
            for item_time, item in recent_emails:
                if candidate_matches_forward_rules(
                    ...
                    if (
                        ...
                        and item_time
                        and (latest_success_time is None or item_time > latest_success_time)
                    ):
            ...
            safe_console_print(
                ...
                f"filtered_skip={result['filtered_skip_count']} "
