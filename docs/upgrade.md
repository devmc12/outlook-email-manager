...
```bash
docker pull ghcr.io/devmc12/outlook-email-manager:v2.0.15
docker compose down
docker compose up -d
```
...
services:
  outlook-mail-reader:
    image: ghcr.io/devmc12/outlook-email-manager:v2.0.15
```
...
```bash
docker pull ghcr.io/devmc12/outlook-email-manager:v2.0.13
docker compose down
docker compose up -d
```
